              ...
              data?.map((image) => {
                return (
                  <button
                    ...
                    key={image.id}
                    className="relative w-full group h-[100px] hover:opacity-75 transition bg-muted rounded-sm overflow-hidden border"
                  >
                    <Image
                      fill
                    ...
                    <Link
                      ...
                      className="opacity-0 group-hover:opacity-100 absolute bottom-0 left-0 text-[10px] w-full truncate text-white hover:underline p-1 bg-black/50 text-left"
                    >
                      {image.user.name}
                    </Link>
                  </button>
